...
\noindent Le présent règlement a été ratifié par les représentants du Bureau le 29/08/2017.
...
\section{Modalité d'adhésion et cotisation}
    ...
    \subsection{Moyens de payement}
		...
		Les seuls moyens de paiement acceptés par l'association sont :
			...
			\begin{itemize}
		    	...
		    	\item[\textbullet] En espèces pour l’abonnement annuel uniquement 
		    \end{itemize}
    ...
    \subsection{Accès au réseau et services mis à disposition}
		...
		Néanmoins, un ou plusieurs de ces services peuvent être indisponibles à tout moment, que ce soit pour des raisons techniques ou à l'occasion d’événements spéciaux, et ce sans aucun recours possible de la part de l'adhérent.
